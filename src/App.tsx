...
function App() {
  ...
  const [imageOffset, setImageOffset] = useState(-100); // Adjustable offset in pixels
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative w-full max-w-md h-96 border border-gray-700 rounded-xl overflow-hidden">
                <img
                  src={profile}
                  alt="Profile"
                  className="absolute top-0 left-0 w-full object-cover transition-transform duration-200"
      ...
      <section id="technologies" className="py-16 md:py-20 bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 justify-items-center">
            {technologies.map((tech, index) => {
              ...
              return (
                <div key={index} className="group relative w-full max-w-[180px]">
                  <div className="bg-gray-800 p-4 md:p-6 rounded-xl border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:transform hover:scale-105">
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-lg bg-gradient-to-r ${tech.color} p-2 md:p-3 mb-3 md:mb-4 mx-auto`}>
                      <IconComponent size={20} md:size={24} className="text-white" />
                    </div>
                    <h3 className="text-base md:text-lg font-semibold text-white text-center">{tech.name}</h3>
                  </div>
                </div>
              );
            })}
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700">
              <h4 className="text-lg md:text-xl font-semibold text-white mb-4 text-center md:text-left">Programming Languages</h4>
            ...
            <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700">
              <h4 className="text-lg md:text-xl font-semibold text-white mb-4 text-center md:text-left">Frameworks & Tools</h4>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
            ...
            <div className="bg-gray-800/50 p-4 md:p-6 rounded-xl border border-gray-700">
              <h4 className="text-lg md:text-xl font-semibold text-white mb-4 text-center md:text-left">Databases & Cloud</h4>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
      ...
      {/* Projects Section */}
      <section id="projects" className="py-16 md:py-20 bg-gray-800/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
      ...
      <section id="contact" className="py-16 md:py-20 bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-gray-800 p-6 md:p-8 rounded-xl border border-gray-700 space-y-6">
              <h3 className="text-xl font-semibold text-white">Education & Background</h3>
...
//   const [showScrollTop, setShowScrollTop] = useState(false);
//   const [currentProjectIndex, setCurrentProjectIndex] = useState(0);
//   const [imageOffset, setImageOffset] = useState(-141); // Adjustable offset in pixels
...
//             </div>
//             <div>
//               <div className="relative w-full h-96 border border-gray-700 rounded-xl overflow-hidden">
//                 <img
//                   src={profile}
//                   alt="Profile"
//                   className="absolute top-0 left-0 w-full object-cover transition-transform duration-200"
